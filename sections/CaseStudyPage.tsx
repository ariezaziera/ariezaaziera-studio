...
// ─── CaseSection (context/problem/solution/outcome) ──────────────────────────
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* URL bar */}
        <div style={{
          flex: 1, height: 22, borderRadius: 4, background: "#111",
          border: `1px solid ${BORDER}`, display: "flex", alignItems: "center",
          padding: "0 10px", gap: 6,
        }}>
          <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#27c93f", opacity: 0.6 }} />
          <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 9, color: "#444", letterSpacing: 0.5 }}>
            {`localhost:3000`}
          </span>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(min(200px,100%),1fr))", gap: 12 }}>
        {screenshots.map((src, i) => (
          ...
          >
            ...
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" style={{ opacity: 0, transition: "opacity 0.2s" }}
          ...
          <>
            ...
            <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: `linear-gradient(135deg, ${color}12 0%, transparent 70%)`, position: "relative" }}>
              ...
              <div style={{ textAlign: "center", zIndex: 1 }}>
                ...
                >
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="#000" style={{ marginLeft: 4 }}>
...
export default function CaseStudyPage({ project, setActivePage }: CaseStudyPageProps) {
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "100px clamp(20px,6vw,40px) 80px" }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{
            ...
            opacity: heroVisible ? 1 : 0,
            animation: heroVisible ? "badgeBounce 0.6s 0.1s both" : "none",
          }}>
          ...
          <h1 style={{
            ...
            fontSize: "clamp(36px,9vw,80px)", lineHeight: 1.0,
            margin: "0 0 20px", letterSpacing: -2,
            opacity: heroVisible ? 1 : 0,
            animation: heroVisible ? "heroSlideUp 0.8s 0.15s both" : "none",
          }}>
          ...
          {/* Tagline */}
          <p style={{
            fontFamily: "'DM Mono', monospace", fontSize: "clamp(12px,2.5vw,14px)",
            color: "#888", lineHeight: 1.7, margin: "0 0 20px",
            opacity: heroVisible ? 1 : 0,
            animation: heroVisible ? "heroSlideUp 0.8s 0.25s both" : "none",
          }}>
            {project.tagline}
          </p>
          ...
          <div style={{
            ...
            opacity: heroVisible ? 1 : 0,
            animation: heroVisible ? "heroFadeIn 0.6s 0.35s both" : "none",
          }}>
        ...
        <div style={{ marginBottom: 64, position: "relative" }}>
          ...
          {mockupType === "both" && (
            <div style={{ position: "relative", zIndex: 1, display: "grid", gridTemplateColumns: "1fr auto", gap: 24, alignItems: "center" }}>
              <DesktopMockup src={heroShot} color={project.color} delay={0.1} />
              <MobileMockup src={screenshots[1] ?? heroShot} color={project.color} delay={0.3} />
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {project.tech.map((t: string) => (
              <span key={t} style={{
                fontFamily: "'DM Mono', monospace", fontSize: 10, color: project.color,
                background: project.color + "15", padding: "4px 10px", borderRadius: 3,
        ...
        {/* ── CTA ───────────────────────────────────────────────────────────── */}
        <div style={{
          marginTop: 64, padding: "clamp(24px,5vw,40px)",
          background: CARD_BG, border: `1px solid ${BORDER}`, borderRadius: 12,
          textAlign: "center",
          boxShadow: `0 0 60px ${project.color}08`,
        }}>
          <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 800, fontSize: "clamp(18px,4vw,24px)", marginBottom: 12 }}>
            Interested in working together?
          </div>
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, color: "#666", marginBottom: 28 }}>
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
            <button
              ...
              style={{
                ...
                letterSpacing: 2, background: project.color, color: "#000",
                border: "none", padding: "12px 28px", borderRadius: 4, cursor: "pointer",
                transition: "all 0.2s",
              }}
            ...
            {project.live_url && (
              <a
                ...
                style={{
                  fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 700,
                  letterSpacing: 2, background: "transparent", color: "#fff",
                  border: `1px solid ${BORDER}`, padding: "12px 28px", borderRadius: 4,
