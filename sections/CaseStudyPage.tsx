  ...
  return (
    <div
      ...
      style={{
        ...
        transition: `all 0.7s ${index * 0.12}s cubic-bezier(0.22,1,0.36,1)`,
      }}
    >
...
function ArrowNav({
  ...
  const onEnter = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    e.currentTarget.style.background = "rgba(12,12,12,0.96)";
  };
...
function BothMockup({ ss, color }: { ss: SplitScreenshots; color: string }) {
  ...
  const gap = 20;
  const desktopW = isMobileScreen ? containerW : Math.floor((containerW - gap) * 0.7);
    ...
    >
      ...
      <div
        style={{
          ...
          aspectRatio: "16/9",
          background: "#0a0a0a",
          boxShadow: `0 24px 60px rgba(0,0,0,0.5), 0 0 80px ${color}10`,
        }}
      >
        {playing ? (
          isYouTube ? (
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "100px clamp(20px,6vw,40px) 80px" }}>
        ...
        <div style={{ marginBottom: 64, position: "relative", maxWidth: 900, margin: "0 auto 64px" }}>
          ...
          {mockupType === "mobile" && (
            <div style={{ display: "flex", justifyContent: "center", position: "relative", zIndex: 1 }}>
              <MobileMockup srcs={ss.mobile} color={project.color} delay={0.1} width={Math.round(460 * PHONE_RATIO)} />
            </div>
          )}
              ...
              {i < steps.length - 1 && (
                <div
                  style={{
                    width: 16,
                    height: 1,
                    background: i < activeStep ? project.color : BORDER,
        ...
        >
          <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "clamp(10px,1.4vw,12px)", color: "#555", letterSpacing: 2, flexShrink: 0 }}>
            TECH
          </div>
        ...
        >
          ...
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "clamp(12px,1.6vw,14px)", color: "#666", marginBottom: 28 }}>
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
            <button
              ...
              onMouseEnter={(e: ReactMouseEvent<HTMLButtonElement>) => {
                e.currentTarget.style.transform = "translateY(-2px)";
                e.currentTarget.style.boxShadow = `0 8px 24px ${project.color}40`;
              }}
              onMouseLeave={(e: ReactMouseEvent<HTMLButtonElement>) => {
                e.currentTarget.style.transform = "";
                e.currentTarget.style.boxShadow = "";
