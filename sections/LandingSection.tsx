    ...
    [
      ...
      <div
        ...
        style={{
          ...
          width: size,
          height: size,
          borderTop: pos.top !== undefined ? `${thickness}px solid ${YELLOW}` : "none",
          borderBottom: pos.bottom !== undefined ? `${thickness}px solid ${YELLOW}` : "none",
          borderLeft: pos.left !== undefined ? `${thickness}px solid ${YELLOW}` : "none",
          borderRight: pos.right !== undefined ? `${thickness}px solid ${YELLOW}` : "none",
    ...
    >
      ...
      <style>{`
        ...
        @keyframes mobileCardEnter {
          0% { transform: translateX(120%) translate(-50%, -50%) scale(0.82); opacity: 0; filter: blur(10px); }
          60% { transform: translateX(-8%) translate(-50%, -50%) scale(1.03); opacity: 1; filter: blur(0px); }
          100% { transform: translateX(0) translate(-50%, -50%) scale(1); opacity: 1; filter: blur(0px); }
        }
        @keyframes mobileCardWait {
          0%, 100% { transform: translateX(0) translate(-50%, -50%); opacity: 1; }
        }
        @keyframes mobileCardExit {
          0% { transform: translateX(0) translate(-50%, -50%); opacity: 1; }
          100% { transform: translateX(-120%) translate(-50%, -50%); opacity: 0; }
        }
        @keyframes cardFlip {
      ...
      >
        ...
        <div>
          <div style={{
            ...
            color: YELLOW, letterSpacing: 3, marginBottom: 24,
          ...
          <h1 style={{
            ...
            lineHeight: 1, margin: "0 0 32px", letterSpacing: -1,
          }}>
            {lines.map((line, i) => (
              <div key={i}>
                {i === 1 ? (
          ...
          <div
            ...
            style={{ display: "flex", gap: 12, flexWrap: "wrap", opacity: 0, animation: "fadeUp 0.6s 1s forwards" }}
          >
            <button
              onClick={() => setActivePage("projects")}
              style={{
                fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 700,
                letterSpacing: 2, background: YELLOW, color: "#1E0305",
                border: "none", padding: "14px 28px", borderRadius: 4,
                cursor: "pointer", transition: "0.2s",
              }}
              onMouseEnter={(e: ReactMouseEvent<HTMLButtonElement>) => {
                e.currentTarget.style.transform = "translateY(-2px)";
                e.currentTarget.style.boxShadow = `0 8px 24px ${YELLOW}50`;
              }}
            ...
            <button
              ...
              style={{
                fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 700,
                letterSpacing: 2, background: "transparent", color: "#F0E6D3",
                border: `1px solid ${BORDER}`, padding: "14px 28px",
        ...
        <div
          ...
          style={{
            ...
            flexShrink: 0, marginBottom: "80px",
          }}
        >
          <div style={{ position: "relative", width: "clamp(180px, 22vw, 280px)" }}>
            {[
              { top: -8, left: -8 },
              { top: -8, right: -8 },
              { bottom: -8, left: -8 },
              ...
              <div key={i} style={{
                ...
                borderTop: pos.top !== undefined ? `2px solid ${YELLOW}` : "none",
                borderBottom: pos.bottom !== undefined ? `2px solid ${YELLOW}` : "none",
                borderLeft: pos.left !== undefined ? `2px solid ${YELLOW}` : "none",
                borderRight: pos.right !== undefined ? `2px solid ${YELLOW}` : "none",
                animation: `cornerPulse ${2 + i * 0.3}s ease-in-out infinite`, zIndex: 3,
              }} />
            ))}

            <div style={{
              position: "absolute", top: 12, left: -4,
              width: 3, height: "calc(100% - 24px)",
